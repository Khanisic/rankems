    ...
    <div className="bg-bg min-h-screen pb-30">
      ...
      <div className="flex justify-center items-center pt-10">
        <Link href="/about" className="text-black  bg-yellow group hover:bg-bg border-b-4 hover:border-yellow  hover:text-yellow border-white md:px-6 px-4 py-1 rounded-full flex gap-2 items-center cursor-pointer transition-colors" >
          <p className="text-black font-mono md:text-xl text-lg group-hover:text-yellow">About Developer</p>
      ...
      <div className="md:py-20 py-4">
        ...
        <div className="flex md:flex-row flex-col z-10 gap-8 items-center justify-center pt-5">
          <Link href="/create">
            <button className="text-white relative bg-blue group hover:bg-bg border-b-2 hover:border-blue  hover:text-blue border-white md:px-6 px-4 py-1 rounded-full w-full flex gap-2 items-center cursor-pointer transition-colors">
          ...
          <button className="text-white bg-purple group hover:bg-bg border-b-2 hover:border-purple  hover:text-purple border-white md:px-6 px-4 py-1 rounded-full flex gap-2 items-center cursor-pointer transition-colors" >
            <p className="text-white font-mono md:text-xl text-lg group-hover:text-purple">Rank Existing</p>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 group-hover:text-white transition-all ease-in-out duration-300">
              <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25" />
            </svg>
