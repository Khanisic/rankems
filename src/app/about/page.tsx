    ...
    return (
        <div className="bg-bg min-h-screen pb-30">
            ...
            <div className="max-w-4xl mx-auto px-6 pt-16">
                ...
                {/* Bio Section */}
                <div className="bg-bg border border-border-box rounded-2xl p-8 mb-8">
                    <h2 className="text-green font-mono text-3xl lg:text-4xl mb-6">Who Am I?</h2>
                    <div className="text-white font-base text-lg leading-relaxed space-y-4">
                        <p>
                ...
                {/* Links Section */}
                <div className="bg-bg border border-border-box rounded-2xl p-8 mb-8">
                    <h2 className="text-red font-mono text-3xl lg:text-4xl mb-6">Connect With Me</h2>
