...
function Mine() {
    ...
    return (
        <div className="bg-bg min-h-screen md:px-20 px-5 pb-20">
            <head>
                <title>My Rankems - Your Voting History & Created Games | Rankems</title>
                <meta name="description" content="View all the ranking games you've voted on or created. Track your voting history, see game results, and manage your Rankems activity in one place. Edit your votes anytime!" />
                <meta name="keywords" content="my rankems, voting history, created games, ranking history, vote tracker, my votes, game dashboard, ranking dashboard, personal rankems" />
                <meta name="author" content="Abdul Moid Khan" />
                <meta name="robots" content="index, follow" />
                <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                <link rel="canonical" href="https://rankems.xyz/my-rankems" />
                
                {/* Open Graph / Facebook */}
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://rankems.xyz/my-rankems" />
                <meta property="og:title" content="My Rankems - Your Voting History & Created Games" />
                <meta property="og:description" content="View all the ranking games you've voted on or created. Track your voting history, see game results, and manage your Rankems activity in one place." />
                {/* <meta property="og:image" content="https://rankems.xyz/og-my-rankems.jpg" />
                ...
                <meta property="twitter:url" content="https://rankems.xyz/my-rankems" />
                <meta property="twitter:title" content="My Rankems - Your Voting History & Created Games" />
                <meta property="twitter:description" content="View all the ranking games you've voted on or created. Track your voting history and manage your Rankems activity." />
                <meta property="twitter:image" content="https://rankems.xyz/twitter-my-rankems.jpg" /> */}
                ...
                <script type="application/ld+json">
                  {JSON.stringify({
                    ...
                    "@type": "WebPage",
                    "name": "My Rankems - Personal Dashboard",
                    "description": "Personal dashboard showing all ranking games you've participated in or created. View voting history and manage your Rankems activity.",
                    ...
                    "potentialAction": [
                      {
                        "@type": "ViewAction",
                        "target": "https://rankems.xyz/my-rankems",
                        "name": "View My Rankems"
                      },
                      {
                        "@type": "CreateAction",
                        "target": "https://rankems.xyz/create",
                        "name": "Create New Rankem"
                      }
                    ],
                    "breadcrumb": {
                      "@type": "BreadcrumbList",
                      "itemListElement": [
                        {
                          ...
                          "position": 1,
                          "name": "Home",
                          "item": "https://rankems.xyz"
                        },
                        {
                          "@type": "ListItem",
                          "position": 2,
                          "name": "My Rankems",
                          "item": "https://rankems.xyz/my-rankems"
                        }
                      ]
                    }
                  })}
