        ...
        <div className='w-full h-full flex flex-col justify-center gap-1 items-center max-w-7xl mx-auto px-5 py-20 md:px-10 md:py-10'>
            ...
            <div className='flex flex-col-reverse md:flex-row justify-around items-center'>
                ...
                <div className='w-full md:w-1/2 h-full  flex flex-col justify-center text-center items-start px-5 md:px-10'>
                    ...
                    <p className='text-lg md:text-2xl text-pink-light font-lond w-full leading-6'>Items are then ranked based on the category, users can drag and drop the items based on their desired rankings. If the mode is set to restricted, then users are asked to select who they are from the created items.</p>
            ...
            <div className='flex flex-col md:flex-row justify-around items-center'>
                <div className='w-full md:w-1/2 h-full flex flex-col justify-center text-center items-start px-5 md:px-10'>
                    ...
                    <p className='text-lg md:text-2xl text-green-light font-lond w-full leading-6'>Points are awarded based on what users rank the items, if there are 6 items then the item ranked first is given 6 points and item ranked 5th is given 5 points and so on...</p>
                </div>
                <div className='w-full md:w-1/2 h-full gap-10 flex justify-center items-center'>
            ...
            <div className='flex flex-col-reverse md:flex-row justify-around items-center'>
                ...
                <div className='w-full md:w-1/2 h-full  flex flex-col justify-center text-center items-start px-5 md:px-10'>
                    ...
                    <p className='text-lg md:text-2xl text-blue-light font-lond w-full leading-6'>If you are ranking among your friends, then only your friends can rank, they are prompted to select which friend (item) they are before ranking.</p>
                </div>
